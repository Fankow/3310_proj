...
public class FirestoreManager {
    ...
    public void saveTrip(final Trip trip, final DataCallback<Trip> listener) {
        ...
        if (trip.getOwnerId() == null || trip.getOwnerId().isEmpty()) {
            trip.setOwnerId(currentUser.getUid());
        }
     ...
     * @param listener Callback for success/failure
     */
    public void deleteTrip(String tripId, final DataCallback<Boolean> listener) {
        db.collection(TRIPS_COLLECTION).document(tripId)
                .delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
